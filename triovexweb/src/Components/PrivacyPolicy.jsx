...
const PrivacyPolicy = () => {
  return (
    <div className="bg-white text-[#313719] px-6 py-12 lg:px-32  my-20 max-w-6xl  mx-auto">
      <h1 className="text-4xl font-bold mt-4 mb-2 text-[#313719] text-center">Privacy Policy</h1>
      ...
      <section className="space-y-6 text-lg my-6">
        <p>
          ...
          trust. At Triovex Solution, your privacy is not just a policy, it’s a
          promise. We are committed to protecting your personal information and
        ...
        <div>
          ...
          <p>
            ...
            Digital Marketing, and more. And yes, we take your privacy seriously
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Send you service updates or offers (only with your consent!)
            </li>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              ...
              <a
                ...
                className="underline text-[#313719]"
              >
                support@triovexsolution.com
              </a>{" "}
              or use our{" "}
              <a href="/contact" className="underline text-[#313719]">
                contact form
              </a>
              .
            </li>
