  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 cursor-none">
        ...
        >
          We’re building intelligent digital products with AI at the core and
          we’re always looking for curious minds, creative thinkers, and tech
          innovators to grow with us.
        </p>
      </div>
    </div>
  );
